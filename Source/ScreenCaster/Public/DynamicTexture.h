...
*/
UCLASS(BlueprintType, Blueprintable, Category = "ScreenCaster", META = (DisplayName = "ScreenCaster Dynamic Texture", BlueprintSpawnableComponent))
class SCREENCASTER_API UDynamicTexture : public UObject
{
	GENERATED_BODY()
